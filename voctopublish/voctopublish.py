...
class Worker:
    ...
    def __init__(self):
        ...
        self.logger.debug("creating C3TTClient")
        try:
    ...
    def get_ticket_from_tracker(self):
        ...
        """
        self.logger.info("requesting ticket from tracker")
    ...
    def _publish_to_voctoweb(self):
        ...
        if self.ticket.language_index is not None:
            self.voctoweb_filename = (
                self.ticket.language_template
                % self.ticket.languages[self.ticket.language_index]
                + "_"
